                                      ...
                                      Row(
                                        children: [
                                          ...
                                          CustomButtom(
                                            ...
                                            ontap: () async {
                                              // appProvider
                                              //     .addServiceToWatchListPro(
                                              //         serviceModel);

                                              await FirebaseFirestoreHelper
                                                  .instance
                                                  .addServiceTOWatchListFB(
                                                      serviceModel,
                                                      widget.salonModel.name);
                                              showMessage("Service To Watch");
                                            },
                                          ),
                                        ],
                                      ),
...
//       await appProvider.callBackFunctionWinderservice(
//         widget.salonModel.id,
//         widget.salonModel.adminId,
//         widget.categoryModel.id,
//       );
...
//                       ),
//                     )
//                   : appProvider.getServiceList.isEmpty
//                       ? Center(
//                           child: Padding(
//                             padding:
//                                 EdgeInsets.only(top: Dimensions.dimenisonNo55),
...
//                           physics: const NeverScrollableScrollPhysics(),
//                           shrinkWrap: true,
//                           itemCount: appProvider.getServiceList.length,
//                           itemBuilder: (context, index) {
//                             ServiceModel serviceModel =
//                                 appProvider.getServiceList[index];
//                             return Column(
//                               crossAxisAlignment: CrossAxisAlignment.start,
//                               children: [
//                                 const CustomDotttedLine(),
...
//                                                       serviceModel);
//                                               print(
//                                                   "Length : ${appProvider.getWatchServiceList.length}");
//                                               showMessage("Service To Watch");
//                                             },
//                                           ),
//                                         ],
